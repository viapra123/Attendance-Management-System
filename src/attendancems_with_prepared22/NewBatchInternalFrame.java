...
Validation v;
    ...
    public void TimingCombo(){
        try {jComboBoxTiming.addItem("Please Select....");
            jComboBoxTiming.addItem("8-9");
            jComboBoxTiming.addItem("9-10");
            jComboBoxTiming.addItem("10-11");
            jComboBoxTiming.addItem("12-1");
            jComboBoxTiming.addItem("1-2");
    ...
    try {
        ...
        jComboBoxDay.addItem("Afternoon");
        }
        catch(Exception ex) {
            System.out.println(ex.toString());
        }
    ...
    */
    ...
    private void initComponents() {
        ...
        BackgroundLabel.setBackground(new java.awt.Color(111, 102, 112));
